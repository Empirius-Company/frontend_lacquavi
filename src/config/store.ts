...
export const STORES: Store[] = [
  {
    ...
    zip: '31160-551',
    hours: [
      { days: 'Segunda a Sexta', time: '10h às 22h' },
      { days: 'Sábado', time: '10h às 22h' },
      { days: 'Domingo', time: '14h às 20h' },
    ],
  ...
  },
  {
    ...
    street: 'Orla da Lagoa - Av. Getúlio Vargas, 6130',
    complement: 'Loja 47 — Várzea',
    city: 'Lagoa Santa',
    state: 'MG',
    zip: '33400-000',
    hours: [
      { days: 'Segunda a Sexta', time: '10h às 19h' },
      { days: 'Sábado', time: '10h às 14h' },
    ],
    phone: '+55 31 97501-9000',
    whatsapp: '5531975019000',
    email: 'contato@lacquavi.com.br',
    instagram: 'https://instagram.com/lacqua.minas',
    mapsUrl: 'https://www.google.com/maps/dir/?api=1&destination=Av.+Get%C3%BAlio+Vargas,+6130,+V%C3%A1rzea,+Lagoa+Santa,+MG',
    mapEmbedUrl:
